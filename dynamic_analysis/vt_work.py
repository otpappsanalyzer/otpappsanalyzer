...
def upload_vt_domain(domain):
    url = 'https://www.virustotal.com/vtapi/v2/url/scan'
    vt_key = random_key()
    print ('Upload Domain :'+domain)
    print(vt_key)
    params = {'apikey': vt_key,'url': domain}
    
    response = requests.post(url, params=params)

    print("done uploading domain to virustotal")
    return response
...
def main():
    ...
    print(vt_domain_res)
    # domain_scan_res = upload_vt_domain(domain)
    # print(domain_scan_res) 
